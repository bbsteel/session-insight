 ...
 * existing positions API payload: exact tool_call_id first, then turn_index,
 * then nearest timestamp. Unresolvable anchors return null so the caller
 * never jumps to a guessed row.
 */
...
const positions = [
  ...
  { kind: 'tool', position_key: 'tool:0:33', turn_index: 0, line_start: 33, payload: { logical_start: 17, tool_call_id: 'tool_aaa', ts_ms: 2000 } },
