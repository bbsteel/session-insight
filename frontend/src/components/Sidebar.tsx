    ...
    >
      ...
      <div className="p-4 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-2 min-w-0">
          <button type="button" onClick={onHome} aria-label={t('home.overview')} title={t('home.overview')} data-testid="sidebar-home" className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-[var(--accent-blue)]/10 text-helper font-bold text-[var(--accent-blue)] hover:bg-[var(--accent-blue)]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-blue)]">SI</button>
