  ...
  return createPortal(
    <>
      ...
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className="fixed left-1/2 top-1/3 z-[calc(var(--z-modal)+1)] w-[min(420px,calc(100vw-2rem))] -translate-x-1/2 rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] p-4 shadow-lg"
      >
