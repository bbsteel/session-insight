export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ["'Inter'", 'system-ui', '-apple-system', 'BlinkMacSystemFont', "'Segoe UI'", "'Microsoft YaHei UI'", "'Microsoft YaHei'", "'PingFang SC'", 'sans-serif'],
        mono: ["'JetBrains Mono'", "'Consolas'", "'Menlo'", "'SF Mono'", "'Fira Code'", 'monospace'],
      },
    },
  },
}
