...
// Presentation returns Grok Build's adapter-owned terminal presentation.
...
func Presentation() presentation.Declaration {
	return presentation.NativeNeutralDeclaration("grok")
}

// PresentationMigrationState records that Grok still renders via the
