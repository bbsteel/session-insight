...
内建可观测性将 Agent 能力、会话溯源、协作时间线、Token/工具分析与 Git/PR/MR 证据串联起来；通过准确、估算、缺失和不可用状态明示每条结论的可信度，而不隐藏不确定性。
...
- **Git 与变更请求证据** — 查看按仓库归属的本地改动、留存 Patch、候选提交与回放编辑锚点；关联固定版本的 GitHub PR 或 GitLab MR 快照，并明确展示证据质量和可撤销的只读主机授权
